...
import (
	...
	"github.com/connedge/framework/filesystem"
...
func NewGinRequest(ctx *GinContext) http.Request {
...
func (r *GinRequest) File(name string) (filesystem.File, error) {
	panic(fmt.Errorf("File method is not supported in Gin adapter"))
}
...
func (r *GinRequest) Headers() nethttp.Header {
...
func (r *GinRequest) Origin() *nethttp.Request {
